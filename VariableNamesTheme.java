public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        char symbolAnd = '&';
        System.out.println("1.9. Переменная хранит символ & = " + symbolAnd);
        ...
        // дата начала
        String dateStart = "13.11.2024";
        System.out.println("1.20. Дата начала = " + dateStart);
        ...
        System.out.println("1.23. Заголовок электронной книги = " + ebookTitle);
        ...
        // компьютер включен?
        boolean isPcOn = true;
        System.out.println("2.2. компьютер включен? = " + isPcOn);
        ...
        int newCid = 4556;
        System.out.println("3.6. новый идентификатор клиента = " + newCid);
